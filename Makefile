...
mkvirtualenv: ## create the project environment
	@python3 -m venv "$$WORKON_HOME/data-preprosessing-review"
	@. "$$WORKON_HOME/data-preprosessing-review/bin/activate"
	@pip install --upgrade pip setuptools wheel

mkvirtualenv-system: ## create the project environment with system site packages
	@python3 -m venv "$$WORKON_HOME/data-preprosessing-review" --system-site-packages
	@. "$$WORKON_HOME/data-preprosessing-review/bin/activate"
	@pip install --upgrade pip setuptools wheel
