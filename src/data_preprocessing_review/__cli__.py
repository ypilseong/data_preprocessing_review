"""Command line interface for data_preprocessing_review"""

# Importing the libraries

import click

from data_preprocessing_review._version import __version__
...
def main(count, name):
    ...
    for _ in range(count):
        ...
        click.echo(f"This is data_preprocessing_review version {__version__}.")
