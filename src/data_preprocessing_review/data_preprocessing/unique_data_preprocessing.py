...
df_store_new = pd.read_csv('data/filtered_data_with_date_xy.csv', encoding='utf-8', sep=',')
...
for i in range(len(df_store_new)):
    try:
        ...
        result_coord = get_rectangle_coordinates(y_value, x_value, 25, 25)
        store_count = 0
        ...
        df_store_new['num_store'][i] = store_count - 1 
...
df_store_new.to_csv('data/unique_store_data_25.csv', encoding='utf-8', index=False)
